        ...
        <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            <button type="button" onClick={props.openGuestsModal} className="flex items-center gap-2 flex-1 text-left">
              ...
              {props.emailsToInvite.length > 0 ?(
                <span className="text-zinc-100 text-lg flex-1">{props.emailsToInvite.length} pessoa(s) convidada(s)</span>
              ) : (
            ...
            <Button onClick={props.openConfirmTripModal} variant="greenButton">
              Confirmar viagem
